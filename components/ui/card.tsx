...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-sm border-t border-border/20 bg-muted/30 p-(--card-spacing)",
        className
      )}
      {...props}
    />
